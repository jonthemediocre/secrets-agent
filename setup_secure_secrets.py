#!/usr/bin/env python3
"""
setup_secure_secrets.py - Set up secure encrypted secrets storage
"""
...
def create_secure_storage(master_password, secrets_file="secrets.yaml"):
...
"""
    ...
    if os.path.exists(secrets_file):
        ...
        backup = input("Remove original unencrypted secrets.yaml? (y/n): ")
        if backup.lower() == 'y':
            os.rename(secrets_file, f"{secrets_file}.bak")
    else:
